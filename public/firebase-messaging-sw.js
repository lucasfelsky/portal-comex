...
// Necessario para receber push notifications em background (app fechado
// ou em segundo plano). O FCM registra este SW automaticamente quando
// getToken() e chamado com a opcao serviceWorkerRegistration.
//
// Deve estar em public/ para ser servido na raiz do dominio.
// Usa importScripts para carregar o SDK do Firebase compativel com SW.
...
messaging.onBackgroundMessage((payload) => {
  // O FCM ja exibe a notificacao automaticamente quando o payload tem
  // campo notification. Este handler e para extras/custom data.
